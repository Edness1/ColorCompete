...
const FAQ = () => {
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "This depends on your subscription tier. Free users get 2 submissions per month, while paid subscribers get more based on their plan. Check your profile to see your current limits. Remember, you must be 18+ to participate.",
    },
    {
      question: "Is there an age requirement to participate?",
      answer:
        "Yes, ColorCompete is restricted to users who are 18 years of age or older. You must verify your age during account creation. Coming soon! ColorUnplugged for children, age appropriate coloring contest for children with parental dashboard.",
    },
    {
