      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg dark:prose-invert mx-auto space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4">
                7. Age Restrictions and Privacy
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                ColorCompete is exclusively available to users who are 18 years
                of age or older. Our service is not intended for minors under
                ...
                such information, we will take immediate steps to delete it and
                terminate the associated account.
              </p>
              <p className="text-muted-foreground leading-relaxed mt-4">
                We require age verification during account creation to ensure
                compliance with this policy. Users who misrepresent their age
