...
export default function AuthModal({
  ...
  const handleOAuthSignIn = async (
    provider: "google" | "facebook" | "apple" | "instagram" | "tiktok",
  ) => {
    setIsSubmitting(true);
    try {
      ...
      if (error) throw error;
      // Note: OAuth will redirect, so we don't need to show success message or close modal
    } catch (error: any) {
              ...
              <div className="space-y-3">
                ...
                >
                  <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
                    <path
                      fill="#000000"
                      d="M19.589 6.686a4.793 4.793 0 0 1-3.77-4.245V2h-3.445v13.672a2.896 2.896 0 0 1-5.201 1.743l-.002-.001.002.001a2.895 2.895 0 0 1 3.183-4.51v-3.5a6.329 6.329 0 0 0-1.032-.083 6.411 6.411 0 0 0-6.4 6.4 6.411 6.411 0 0 0 6.4 6.4 6.411 6.411 0 0 0 6.4-6.4V8.862a8.031 8.031 0 0 0 4.6 1.39v-3.566a4.808 4.808 0 0 1-.735 0z"
                    />
                  </svg>
